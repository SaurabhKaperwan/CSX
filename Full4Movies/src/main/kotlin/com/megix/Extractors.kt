    ...
    companion object {
        ...
        suspend fun fetchKey(): String {
            return if (key != null) {
                ...
                val fetch = app.get("https://raw.githubusercontent.com/phisher98/multi-keys/keys/keys.json").parsedSafe<Keys>()?.key?.get(0) ?: throw ErrorLoadingException("Unable to get key")
                key = fetch
                key!!
            }
        }
