...
class CineSimklProvider: MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "/tv/genres/tv/all-types/all-countries/all-networks/this-year/popular-today?limit=$mediaLimit&page=" to "Top Rated Shows This Year",
        ...
        "/tv/genres/all/all-types/all-countries/appletv/all-years/popular-today?limit=$mediaLimit&page=" to "Trending Apple TV+ Shows",
        ...
        "/tv/genres/tv/all-types/all-countries/all-networks/all-years/rank?limit=$mediaLimit&page=" to "Top Rated Shows",
