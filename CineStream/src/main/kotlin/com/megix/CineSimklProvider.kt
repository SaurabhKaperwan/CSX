...
class CineSimklProvider: MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "/movies/genres/all/all-types/all-countries/this-year/rank?limit=$mediaLimit&page=" to "Top Rated Movies This Year",
        "/tv/genres/all/all-types/all-countries/all-networks/this-year/rank?limit=$mediaLimit&page=" to "Top Rated Shows This Year",
