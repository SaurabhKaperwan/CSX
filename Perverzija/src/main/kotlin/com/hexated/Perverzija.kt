...
class Perverzija : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/studiovnx/page/%d/?orderby=view" to "Most Viewed Vxn",
        "$mainUrl/studio/vxn/page/%d/?orderby=like" to "Most Liked Vxn",
        "$mainUrl/studio/vxn/page/%d/?orderby=comment" to "Most Vxn",
        "$mainUrl/studio/wicked/page/%d/?orderby=date" to "Wicked",
        "$mainUrl/studio/twistysnetwork/page/%d/?orderby=date" to "Twistys Network",
        "$mainUrl/studio/tonightsgirlfriend/page/%d/?orderby=date" to "Tonight's Girlfriend",
        ...
        "$mainUrl/tag/18-year-old/page/%d/" to "18 Year Old",
        "$mainUrl/tag/watching/page/%d/" to "Watching",
        "$mainUrl/tag/taboo/page/%d/" to "Taboo",
        "$mainUrl/tag/sister/page/%d/" to "Siter",
